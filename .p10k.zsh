...
() {
  ...
  typeset -g POWERLEVEL9K_RULER_FOREGROUND=$black
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local   modified='%202F'  # yellow foreground
  ...
  # Yellow foreground previous command duration.
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=$yellow
  # transparent background previous command duration.
