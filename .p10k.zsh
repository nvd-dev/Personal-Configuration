# Generated by Powerlevel10k configuration wizard on 2021-07-09 at 15:38 +07.  # Based on romkatv/powerlevel10k/config/p10k-pure.zsh, checksum 13301.  # Wizard options: nerdfont-complete + powerline, large icons, pure, rpromt, 2 lines, # compact, transient_prompt, instant_prompt=verbose.  # Type `p10k configure` to generate another config.  # # Config file for Powerlevel10k with the style of Pure (https://github.com/sindresorhus/pure).
#
